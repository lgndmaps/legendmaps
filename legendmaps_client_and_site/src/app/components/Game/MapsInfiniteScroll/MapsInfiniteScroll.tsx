...
import useInfiniteAdventurersQuery from "../../../hooks/useInfiniteAdventurersQuery";
import { string } from "mobx-state-tree/dist/internal";

const DynamicAllAdventurers = dynamic(() => import("./AllMaps"), {
    ssr: false,
});
...
export const MyAdventurerInfiniteScroll = observer((): JSX.Element => {
