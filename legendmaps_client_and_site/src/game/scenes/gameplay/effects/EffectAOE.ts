...
export default class EffectAOE extends MapEffect {
    private delay: number = 0;
    public damageType: GlobalConst.DAMAGE_TYPES;

    override Init(gameScene: GameScene, startTile: GameMapTile, delayVisualEffect: number = 0): EffectAOE {
        ...
        let em1 = this.AddParticleSystem(
            {
                ...
                gravityY: 0,
                emitZone: { type: "random", source: new Phaser.Geom.Circle(this.startPos.x, this.startPos.y, 82) },
