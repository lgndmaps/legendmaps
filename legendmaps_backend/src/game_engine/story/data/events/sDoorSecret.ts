...
export default class StoryEventDoorSecretH extends StoryEventData {
    constructor() {
        super(GlobalConst.STORY_EVENT_KEYS.DOOR_SECRET_H, GlobalConst.STORY_EVENT_CATEGORY.DOOR);
        this.ascii = "-";
